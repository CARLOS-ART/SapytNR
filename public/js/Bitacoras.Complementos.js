var $container9 = $("#complementos");
var $parent = $container9.parent();
  var data = [
    ["", "", "", "", "", "", ""]
  ];
...
Handsontable.cellLookup.renderer.negativeValueRenderer = negativeValueRenderer;
  ...
  $container9.handsontable(config);
  ...
  var handsontable = $container9.data('handsontable');

  /*================================================================ */

  function valorCell(Fila){
    //funcion para obtener el ID
      $("#btnComentarios").data("item",$container9.handsontable('getDataAtCell',Fila,0));
    }

    function CargaProductoBitacoraComplementos(){
      var Clasif = Array();
      Clasif[0]=9;
      ...
      $.ajax({
        ...
        success:function(data){
          H5_loading.hide();
             ...
             $container9.handsontable('updateSettings',{data:data.Json,
               ...
               $container9.handsontable('updateSettings',{
                 cells: function (row, col ,prop) {
                 var cellProperties = {};
                 switch (prop) {
