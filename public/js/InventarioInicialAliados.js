...
var $parent = $container.parent();
  ...
  $.ajax({
    ...
    type:'post',
    data:{_token:_token,Inventario:Json,BASF:0},
    beforeSend:function(){
    ...
    error:function(){
      CircleNotification('Operación no realizada','No se pudo realizar la carga del inventario inicial, por favor intentelo nuevamente','error',"top-left");
    }
  });
...
$(".LineaProducto").click(function(){
  ...
  $.ajax({
    ...
    type:'post',
    data:{_token:_token,Linea:Linea,Seleccionar:Seleccionar,BASF:0},
...
function CargarDatos(){
  ...
  $.ajax({
    ...
    error:function(){
      H5_loading.hide();
      CircleNotification('Error!','No fue posible consultar el catalogo de productos, ocurrio un error de comunicación con el servidor, por favor intentelo nuevamente','error',"top-left");
    }
  });
}
