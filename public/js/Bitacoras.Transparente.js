...
Handsontable.cellLookup.renderer.negativeValueRenderer = negativeValueRenderer;
  ...
  $container2.handsontable(config);
  ...
  var handsontable = $container2.data('handsontable');

  /*================================================================ */

  function valorCell(Fila){
    //funcion para obtener el ID
      $("#btnComentarios").data("item",$container2.handsontable('getDataAtCell',Fila,0));
    }


    function CargaProductoBitacoraTransparentes(){
      var Clasif = Array();
      Clasif[0]=4;
      ...
      $.ajax({
        ...
        success:function(data){
          H5_loading.hide();
             ...
             $container2.handsontable('updateSettings',{data:data.Json,
