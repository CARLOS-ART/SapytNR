        ...
        if ($("#echart_pie2").length) {
            ...
            h.setOption({
                ...
                legend: {
                    x: "center",
                    y: "bottom",
                    data: ["BMW", "Volkswagen", "Chevrolet", "Ford", "Dodge", "Nissan"]
                },
                toolbox: {
                    show: !0,
                    feature: {
        ...
        if ($("#echart_donut").length) {
            ...
            i.setOption({
                ...
                legend: {
                    x: "center",
                    y: "bottom",
                    data: ["FCA 1", "FCA 2", "FCA 3", "FCA 4", "FCA 5"]
                },
                toolbox: {
                    show: !0,
                    feature: {
        ...
        if ($("#echart_pie").length) {
            ...
            j.setOption({
                ...
                legend: {
                    x: "center",
                    y: "bottom",
                    data: ["Pendientes", "En proceso", "Surtiendo", "Enviados", "Completados"]
                },
                toolbox: {
                    show: !0,
                    feature: {
        ...
        if ($("#echart_mini_pie").length) {
            ...
            m.setOption({
                ...
                legend: {
                    ...
                    y: 45,
                    itemGap: 12,
                    data: ["68%Completados", "29%Surtiendo", "3%Pendientes"]
                },
                toolbox: {
                    show: !0,
                    feature: {
