      ...
      {{csrf_field()}}
        <div class="inner">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Pieza Importe</li>
            </ol>
            <!-- END BREADCRUMB -->
            <div class="row">
                ...
                <div class="col-xl-5 col-lg-6 ">
                    ...
                    <div class="card card-transparent">
                        ...
                        <div class="card-body">
                            <h3>Estadisticas de Pieza e importe</h3>
            ...
            <div class="card card-default">
              <div class="card-header ">
                <div class="card-title">
                  <h5>Reportes de piezas e importes</h5>
                </div>
              </div>
              <div class="card-body">
              <div class="row">
                ...
                <div class="col-lg-4">
                  <p class="col-sm-5 p-l-0"></p>
                      ...
                      id="btnVerRpt" name="btnVerRpt" type="button" onclick="ReportPiezaImporte(txtFecha.value,txtFecha2.value);">Ver Reporte</button>
                </div>
                <br>
              </div>
            </div>
