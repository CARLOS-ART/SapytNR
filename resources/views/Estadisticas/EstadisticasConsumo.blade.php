    ...
    <div class=" container-fluid   container-fixed-lg sm-p-l-0 sm-p-r-0">
        <div class="inner">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Consumo Productos</li>
            </ol>
            <!-- END BREADCRUMB -->
            <div class="row">
                ...
                <div class="col-xl-5 col-lg-6 ">
                    ...
                    <div class="card card-transparent">
                        ...
                        <div class="card-body">
                            ...
                            <p>En este modulo podrá consultar el consumo de productos y de igualados</p>
          ...
          <div class="card card-default">
            ...
            <div class="card-header ">
              <div class="card-title">
                <h5>Reportes de comsumo de productos</h5>
              </div>
            </div><br>
            <div class="card-body">
            <div class="row">
              ...
              <div class="col-lg-3">
                <p class="col-sm-5">Tipo de Reporte</p>
                  <input type="radio" value="15"  id="optionsRadios" name="optionsRadios">
                  <label for="male">Consumo Productos</label><br>
                  <input type="radio" checked="checked" value="16"  id="optionsRadios" name="optionsRadios">
                  <label for="female">Consumo tintas Igualados</label>
              </div>
              <div class="col-lg-3">
