...
@if(request()->cookie('Auditoria_ID')==false)
  {{redirect()->to('/Auditorias/Tablero')->send()}}
@endif
...
<div class="content">
        ...
        <div class=" container-fluid   container-fixed-lg sm-p-l-0 sm-p-r-0">
            <div class="inner">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Auditoría almacén</li>
                </ol>
                <!-- END BREADCRUMB -->
                <div class="row">
                    ...
                    <div class="col-xl-5 col-lg-6 ">
                        ...
                        <div class="card card-transparent">
                            ...
                            <div class="card-body">
                                <h3>Auditoría almacén</h3>
                                <p>En este modulo podrá una auditoría de los productos sellados, ingrese la clave o codigo SAP del prodcuto en el cuadro de busqueda e ingrese el numero de existencia en fisico en la celda de la columna "EXIST. FISICO"
    ...
    <div>
      ...
      <script src="{{asset('js/Auditorias.FormatoAlmacen.js?v=2')}}"></script>
