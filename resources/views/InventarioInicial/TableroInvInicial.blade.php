              ...
              <div class=" container-fluid   container-fixed-lg sm-p-l-0 sm-p-r-0">
                <div class="inner">
                  ...
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Inventario Inicial</li>
                  </ol>
                  <!-- END BREADCRUMB -->
                  <div class="row">
                    ...
                    <div class="col-xl-5 col-lg-6 ">
                      ...
                      <div class="card card-transparent">
                        ...
                        <div class="card-body">
                          ...
                          <p>En este modulo podrá cargar un nuevo inventario <br><br>* Al cargar un inventario inicial, se eliminarán todos los productos que se hallan cargado con anterioridad</p>
                          <p class="small hint-text m-t-5">Haga click en el boton para generar inventario</p>
                          <br>
                          <button class="btn btn-primary" onclick="window.location.href='/InventarioInicial'"href=""  >Nueva carga de inventario</button>
                        </div>
                      </div>
                      <!-- END card -->
                    </div>
                      ...
                      <div class="card-body">
                        <table class="table table-hover demo-table-search table-responsive-block" id="tableWithSearch">
                          ...
                          <tbody>
                            @foreach($Info as $I)
                            <tr>
                              <td class="v-align-middle">{{date('d/m/Y',strtotime($I->FECHA))}}</td>
